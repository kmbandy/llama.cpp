...
public:
    ...
    // nullptr with no indexer, and for the full context: see the note on the full-context
    // constructor in llama-memory-hybrid-idx.cpp for why we do not reserve the sparse graph
