# ─────────────────────────────────────────────────────────────────────────
# REFERENCE COPY — DO NOT IMPORT
#
# Vendored from ROCm/aiter for documentation purposes only. The C++ wrapper
# (../wrappers/mt_aiter_unified_attn.cpp) ports the select_2d_config /
# select_3d_config / use_2d_kernel logic below into runtime dispatch.
#
# When upstream AITER changes its dispatcher heuristics, re-vendor this file
# AND port the deltas into the C++ wrapper.
#
#   Source:   aiter/ops/triton/attention/unified_attention.py
#   Upstream: https://github.com/ROCm/aiter
#   Repo HEAD at vendoring time: 163e6a02517fa9b86abf2f648c97fe6ae74b6d7c (2026-05-20)
#
# Related: ../RDNA4_AUDIT_2026-05-20.md, MAD-203.
# ─────────────────────────────────────────────────────────────────────────
