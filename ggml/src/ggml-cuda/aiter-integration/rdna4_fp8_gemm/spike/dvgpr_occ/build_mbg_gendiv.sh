#!/usr/bin/env bash
# GENDIV (non-pow2 NTL) mbgemm bins for the REAL ml8 shapes + harness recompile.
set -e
cd "$(dirname "$0")"
L=/opt/rocm/llvm/bin
...
mk 0 2 2 occ_mbgemm_2x2_b1_d0_gd
mk 1 2 2 occ_mbgemm_2x2_b1_d1_gd
mk 0 2 4 occ_mbgemm_2x4_b1_d0_gd
mk 1 2 4 occ_mbgemm_2x4_b1_d1_gd
mk 0 4 4 occ_mbgemm_4x4_b1_d0_gd
