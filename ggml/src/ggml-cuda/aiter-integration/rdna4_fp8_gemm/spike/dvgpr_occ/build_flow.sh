...
#
#   2 WG/CU        WAVES=16      (dispatch with ML8_POOL=128 -> 128 WGs x 16 = 2048 waves)
#   SEGK           {64,128,256}  all three publish 13,824B LDS => 2x = 27,648B < 65,536 => all fit 2 WG/CU
...
: ${WAVES:=16}   ; : ${SEGK:=256} ; : ${G:=6}      ; : ${FM:=1}    ; : ${ACC_N:=3}
...
export WAVES SEGK G FM ACC_N JDEPTH POOL_N SSWIN KMAJOR CFASSIGN \
...
echo "== CONFIG OF RECORD: WAVES=$WAVES (2 WG/CU, dispatch ML8_POOL=128) SEGK=$SEGK G=$G FM=$FM ACC_N=$ACC_N"
