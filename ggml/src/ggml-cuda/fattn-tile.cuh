...
static constexpr __host__ __device__ uint32_t ggml_cuda_fattn_tile_get_config_nvidia_fp16(const int DKQ, const int DV, const int ncols) {
    ...
    GGML_CUDA_FATTN_TILE_CONFIG_CASE(576, 512,  2,  64, 2,  32,  64)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE(576, 512,  4, 128, 2,  64,  64)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE(576, 512,  8, 256, 2,  64,  64)
    GGML_CUDA_FATTN_TILE_CONFIG_CASE(576, 512, 16, 256, 2,  64,  64)

    GGML_CUDA_FATTN_TILE_CONFIG_CASE(640, 512,  2,  64, 2,  32,  64)
...
#ifndef GGML_CUDA_NO_FATTN_DKQ640
extern DECL_FATTN_TILE_CASE(640, 512);
#endif // GGML_CUDA_NO_FATTN_DKQ640
