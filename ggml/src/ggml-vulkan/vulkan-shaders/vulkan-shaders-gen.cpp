...
void process_shaders() {
    ...
    string_to_spv("sinkhorn_norm_f32_n2", "sinkhorn_norm.comp", merge_maps(base_dict, {{"N", "2"}}));
    string_to_spv("sinkhorn_norm_f32_n4", "sinkhorn_norm.comp", merge_maps(base_dict, {{"N", "4"}}));
    string_to_spv("sinkhorn_norm_f32_n8", "sinkhorn_norm.comp", merge_maps(base_dict, {{"N", "8"}}));
