...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBO4_64] = {
        .type_name                = "turbo4_64",
        .blck_size                = QK_TURBO4_64,
        .type_size                = sizeof(block_turbo4_64),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo4_64,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo4_64_ref,
    },
    [GGML_TYPE_TURBO4_64_OL] = {
        .type_name                = "turbo4_64_ol",
        .blck_size                = QK_TURBO4_64,
        .type_size                = sizeof(block_turbo4_64_ol),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo4_64_ol,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo4_64_ol_ref,
    },
    [GGML_TYPE_TURBO4_64_OL8] = {
        .type_name                = "turbo4_64_ol8",
        .blck_size                = QK_TURBO4_64,
        .type_size                = sizeof(block_turbo4_64_ol8),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo4_64_ol8,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo4_64_ol8_ref,
    },
    [GGML_TYPE_TURBO4_64_OL12] = {
        .type_name                = "turbo4_64_ol12",
        .blck_size                = QK_TURBO4_64,
        .type_size                = sizeof(block_turbo4_64_ol12),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo4_64_ol12,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo4_64_ol12_ref,
    },
    [GGML_TYPE_TURBO2_0] = {
        .type_name                = "turbo2",
        .blck_size                = QK_TURBO2,
    ...
    [GGML_TYPE_TURBO4_FP8_BS256] = {
        .type_name                = "turbo4_fp8_bs256",
        .blck_size                = 256,  // one block covers a full HEAD_SIZE=256 row
        .type_size                = sizeof(block_turbo4_fp8_bs256),
        .is_quantized             = true,
