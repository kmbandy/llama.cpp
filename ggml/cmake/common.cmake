...
function(ggml_cuda_fattn_vec_instances DIR OUT_SRCS)
    ...
    # fork: TurboQuant KV cache combinations are always compiled, whatever GGML_CUDA_FA_QUANTS says.
    set(FA_TURBO_COMBINATIONS
        turbo3_0-turbo3_0 turbo3_0-q8_0 q8_0-turbo3_0
        turbo2_0-turbo2_0 turbo2_0-q8_0 q8_0-turbo2_0
        turbo3_0-turbo2_0 turbo2_0-turbo3_0
        turbo4_0-turbo4_0 turbo4_0-q8_0 q8_0-turbo4_0
        turbo4_0-turbo3_0 turbo3_0-turbo4_0
        turbo4_0-turbo2_0 turbo2_0-turbo4_0)
    foreach (COMBINATION IN LISTS FA_TURBO_COMBINATIONS)
        string(REPLACE "-" "_" COMBINATION_DEF "GGML_CUDA_FA_${COMBINATION}")
        string(TOUPPER "${COMBINATION_DEF}" COMBINATION_DEF)
        add_compile_definitions(${COMBINATION_DEF}=1)
    endforeach()
