...
struct common_params_speculative_draft {
    ...
    bool    n_max_explicit = false; // set when --spec-draft-n-max is provided
...
struct common_params {
    ...
    float   tensor_split_attn[128] = {0}; // same, for the attention group only; all-zero = follow tensor_split
    bool    has_tensor_split_attn  = false;
    std::string tp_wire_type;           // internal tensor-parallel AllReduce wire codec
